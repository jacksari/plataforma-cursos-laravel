<template>
    <auth-layout>
        <div class="animation-area pt-20 h-screen z-40">
            ...
            <div class="auth">
                ...
                <div class=" mt-20 flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                    ...
                    <div class="w-full p-8 lg:w-1/2">
                        <h2 class="text-2xl font-semibold text-gray-700 text-center">SariDev</h2>
                        ...
                        <form @submit.prevent="login">
                            ...
                            <div class="mt-4">
                                <div class="flex justify-between">
                                    ...
                                    <inertia-link :href="route('password.request')" class="text-xs text-gray-500">¿Has olvidado tu contraseña?</inertia-link>


                                </div>
                                <input v-model="form.password"
                                       type="password"
                                       id="password" class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none"
                                >
                            </div>
                            <div class="mt-8">
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            ...
                            <inertia-link :href="route('register')" class="text-xs text-gray-500 uppercase">¡Regístrate!</inertia-link>
                            <span class="border-b w-1/5 md:w-1/4"></span>
